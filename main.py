...
#if name_input != "none" or "None":
    #name_count += 1
if nacic_input != "none" or "None":
    nacic_count += 1
if state_input != "none" or "None":
    state_count += 1
if women_owned_input != "none" or "None":
    women_owned_count += 1
if eight_a_input != "none" or "None":
    eight_a_count += 1
if disabled_vet_input != "none" or "None":
    disabled_vet_count += 1
if text_input != "none" or "None":
    text_count += 1
if hub_zone_input != "none" or "None":
    hub_zone_count += 1
if smart_filter_input != "none" or "None":
    smart_filter_count += 1
"""
